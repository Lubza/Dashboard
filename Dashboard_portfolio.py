...
adress = r'data/Portfolio_dataset_0623_new.csv'
...
SPY_mtd_2023 = pdr.DataReader('SPY','2023-06-22','2023-06-23')['Adj Close']
...
VNQ_mtd_2023 = pdr.DataReader('VNQ','2023-06-22','2023-06-23')['Adj Close']
