...
adress = r'data/Portfolio_dataset_1023.csv'
...
SPY_mtd_2023 = pdr.DataReader('SPY','2023-09-29','2023-09-30')['Adj Close']
...
VNQ_mtd_2023 = pdr.DataReader('VNQ','2023-09-29','2023-09-30')['Adj Close']
